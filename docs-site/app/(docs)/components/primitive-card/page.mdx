---
title: PrimitiveCard
description: A container widget with shadow, rounded corners, padding, and tap interaction
asIndexPage: true
---
...
<AppEmbed
  src="/demo/#/snippet/primitive_card"
  title="Primitive Card Showcase"
  height={600}
/>
...
<ApiTable
  parameters={[
    ...
    },
    {
      ...
      description: 'Color of the shadow (e.g., Colors.blue.shade800)'
    },
    {
      name: 'padding',
      type: 'EdgeInsets',
    ...
    },
    {
      ...
      required: false,
      default: 'null',
      description: 'Callback invoked when the card is tapped. Provides visual feedback.'
    },
    {
      name: 'semanticsLabel',
      type: 'String?',
    ...
    },
    {
      ...
      description: 'Duration for implicit style animations'
    },
    {
      name: 'curve',
      type: 'Curve',
      ...
      description: 'Curve for implicit style animations'
    }
  ]}
/>
...
<Tabs items={['Low', 'Medium', 'High', 'Custom Shadow']}>
  <Tabs.Tab>
```dart
PrimitiveCard(
  elevation: 2.0,
...
PrimitiveCard(
  elevation: 6.0,
  shadowColor: Colors.blue.shade800, // Custom shadow color
  child: Text('Blue Shadow Card'),
)
```
  </Tabs.Tab>
</Tabs>
...
final Color effectiveShadowColor = shadowColor.withOpacity(shadowOpacity);
```
...
- [PrimitiveToggleSwitch](/components/primitive-toggle-switch) - Common card content

## Source Code

View the complete implementation in the [GitHub repository](https://github.com/Berkay2002/TDDC73/blob/main/project/primitive_ui/lib/src/components/primitive_card.dart).