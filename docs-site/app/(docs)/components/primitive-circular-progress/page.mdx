---
title: PrimitiveCircularProgress
...
<AppEmbed
  src="/demo/#/snippet/primitive_circular_progress"
  title="Primitive Circular Progress Showcase"
  height={500}
/>
...
<ApiTable
  parameters={[
    ...
    },
    {
      ...
      required: false,
      default: 'null',
      description: 'Accessibility label (defaults to "Loading" or "Progress")',
    },
  ]}
/>
...
- [PrimitiveSlider](/components/primitive-slider) - Input for values
- [PrimitiveCard](/components/primitive-card) - Container often used with loaders

## Source Code

View the complete implementation in the [GitHub repository](https://github.com/Berkay2002/TDDC73/blob/main/project/primitive_ui/lib/src/components/primitive_circular_progress.dart).