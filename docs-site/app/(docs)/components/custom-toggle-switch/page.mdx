...
`CustomToggleSwitch` provides a smooth, animated toggle switch using only primitive Flutter components. It demonstrates custom painting, gesture handling, and animation integration without relying on Flutter's Material or Cupertino switch widgets.
...
- [CustomCard](/components/custom-card) - Often contains toggle switches
- [VStack](/components/vstack) - For vertical switch lists

## Source Code

View the complete implementation in the [GitHub repository](https://github.com/Berkay2002/TDDC73/blob/main/project/primitive_ui/lib/src/components/custom_toggle_switch.dart).
