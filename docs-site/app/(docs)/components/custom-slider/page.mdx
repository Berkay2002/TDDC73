...
`CustomSlider` provides a range selection interface using only primitive Flutter components. It tracks gestures to update a value and repaints the slider track and thumb accordingly.
...
- No semantic labels built-in.
</Callout>

## Related Components

- [CustomCircularProgress](/components/custom-circular-progress) - Another value indicator
- [CustomToggleSwitch](/components/custom-toggle-switch) - For boolean values

## Source Code

View the complete implementation in the [GitHub repository](https://github.com/Berkay2002/TDDC73/blob/main/project/primitive_ui/lib/src/components/custom_slider.dart).