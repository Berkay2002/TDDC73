...
**CustomCard** - Demonstrates:
- CustomPaint usage
- Shadow rendering
- Custom layout with padding
- shouldRepaint optimization

**CustomToggleSwitch** - Demonstrates:
- Gesture handling
...
✅ **Widget Construction:**
```dart
testWidgets('CustomCard builds', (tester) async {
  await tester.pumpWidget(
    MaterialApp(home: CustomCard(child: Text('Test'))),
  );
...
- [Primitives Explained](/architecture/primitives-explained)
- [Rendering Pipeline](/architecture/rendering-pipeline)
- [Flutter API Design Guidelines](https://flutter.dev/docs/development/tools/sdk/api-design)
