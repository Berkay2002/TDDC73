...
**In Primitive UI:**
Used by `CustomCard` and `CustomToggleSwitch` for rendering.
...
**In Primitive UI:**
Used by `CustomToggleSwitch` for tap detection.
...
- CustomCard is simpler and more explicit
- Card is production-ready, CustomCard is educational
